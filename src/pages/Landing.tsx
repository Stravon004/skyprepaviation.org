...
const features = [
  { icon: MessageSquare, title: 'AI Oral Exam Simulator', desc: 'Realistic DPE-style questioning powered by AI. Practice scenario-based questions for your specific checkride.', color: 'text-sky-400', bg: 'bg-sky-500/10' },
  { icon: Brain, title: 'Spaced Repetition Flashcards', desc: 'Scientifically proven SM-2 algorithm ensures you review difficult concepts right before you forget them.', color: 'text-emerald-400', bg: 'bg-emerald-500/10' },
  { icon: BookOpen, title: 'Full-Length Practice Exams', desc: 'Timed, realistic exams for PPL, Instrument, Commercial, and ATP. FAA ACS aligned questions.', color: 'text-amber-400', bg: 'bg-amber-500/10' },
  { icon: TrendingUp, title: 'Performance Analytics', desc: 'Track your progress by topic, identify weak areas, and see your readiness score improve over time.', color: 'text-rose-400', bg: 'bg-rose-500/10' },
  { icon: Shield, title: 'Up-to-Date Question Bank', desc: 'Questions curated from actual FAA knowledge tests and regularly updated to match current standards.', color: 'text-teal-400', bg: 'bg-teal-500/10' },
  { icon: Zap, title: 'Study Anywhere', desc: 'Fully responsive web app. Study from your phone, tablet, or desktop whenever and wherever you want.', color: 'text-orange-400', bg: 'bg-orange-500/10' },
]

const testimonials = [
  { name: 'Marcus T.', cert: 'Private Pilot', text: 'I failed my written once before finding SkyPrep. After two weeks using the spaced repetition cards I passed with a 91. The oral simulator especially helped me stop freezing when the examiner asked follow-up questions.', rating: 5 },
  { name: 'Sarah K.', cert: 'Instrument Rating', text: 'The IFR question bank is incredibly thorough. I felt completely prepared walking into my knowledge test. The AI oral sim had me explain approaches, holds, and alternates so many times it became second nature.', rating: 5 },
  { name: 'James R.', cert: 'Commercial Pilot', text: 'Worth every penny. The analytics showed me exactly where I was weak on complex aerodynamics. Went into my commercial checkride confident and came out with zero unsatisfactory areas.', rating: 5 },
]
      ...
      <section className="relative pt-32 pb-24 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Realistic oral exam simulations, spaced repetition flashcards, and full-length practice tests. Built for pilots who want to pass on the first try.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
            <Link to="/signup" className="btn-primary text-base py-4 px-8 flex items-center justify-center gap-2">
              Start Free Today <ArrowRight size={18} />
            </Link>
            <Link to="/pricing" className="btn-secondary text-base py-4 px-8">View Pricing</Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map(({ icon: Icon, title, desc, color, bg }) => (
              <div key={title} className="card hover:border-slate-700 hover:-translate-y-1 transition-all duration-200">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="card bg-gradient-to-br from-sky-900/30 to-slate-900 border-sky-800/30">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link to="/pricing" className="btn-outline text-base py-4 px-8">See Plans & Pricing</Link>
            </div>
          </div>
        </div>
      </section>
